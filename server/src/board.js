...
const THEMES = [
  {
    ...
    general: [
      ...
      { name: "Rusted Rails", description: "The Old Mine Coaster, seized up mid-climb. The cars haven't moved in years.", type: "coaster", searchPool: "medium" },
      ...
      { name: "Midway Mayhem", description: "Carnival Ruins — collapsed game stalls and prize stuffing scattered in the dirt.", type: "carnival", searchPool: "light" },
      { name: "Swamp Run", description: "The Log Flume cuts through a stagnant, overgrown swamp.", type: "swamp", searchPool: "medium" },
      { name: "Deadland Arcade", description: "Broken Games — rows of dead cabinets, one screen still flickering static.", type: "arcade", searchPool: "light" },
  ...
  },
  {
    ...
    general: [
      ...
      { name: "Cabin 1", description: "Bunks and graffiti from summers past.", type: "cabin", searchPool: "light" },
      ...
      { name: "Pinehaven Diner", description: "Cold coffee still sits on the counter.", type: "store", searchPool: "light" },
      ...
      { name: "Camp Counselor Cabin", description: "Someone left the lights on. Nobody's been back to turn them off.", type: "cabin", searchPool: "medium" },
